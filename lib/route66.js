...
var Route66, async, methods, routes, toArray, url, rendering;

rendering = require('./utils').rendering;
...
//    return res.end("Could not " + req.method + " " + req.path);
    return rendering(req.headers.host, '404', {}, req.session.info, req.session.lang, function (layout) {
      res.end(layout);
    });
